  ...
  detailAnime = async (req, res) => {
    ...
    try {
      ...
      const episodesResponse = await Axios.get(
        `${baseUrl}wp-admin/admin-ajax.php?action=epslist&id=${id}`
      );
      ...
      episodes$("body")
        ...
        .each((i, elem) => {
          ...
          const episode = {
            ...
            eps_id: $("li").find("a").attr("href").replace(baseUrl, '')
          };
      ...
      const batchResponse = await Axios.get(
        `${baseUrl}wp-admin/admin-ajax.php?action=batchlist&id=${id}`
      );
      ...
      batch$("body")
        ...
        .each((i, elem) => {
          ...
          const batch = {
            ...
            batch_id: $("li").find("a").attr("href").replace(`${baseUrl}batch/`, ''),
          };
